        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><a href="listeAdherents.php" class="card-link">Voir la liste des adhérents</a></li>
                    <li class="list-group-item"><a href="ajouterAdherent.php" class="card-link">Ajouter un adhérent</a></li>
                    <li class="list-group-item"><a href="listeEmprunts.php" class="card-link">Voir la liste des livres empruntés</a></li>
                    <li class="list-group-item"><a href="emprunterLivre.php" class="card-link">Emprunter un livre</a></li>
                </ul>
            </div>
        </div>
    </div>
